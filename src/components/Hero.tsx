      ...
      <div className="relative z-20 max-w-7xl mx-auto px-6 lg:px-12 w-full pt-20">
        <div className="max-w-4xl animate-fade-in-up">
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
            ...
            <button className="w-full sm:w-auto px-8 py-5 border border-white/30 text-white text-sm font-bold uppercase tracking-widest hover:bg-white hover:text-black transition-all">
              Explore Campus
            </button>
          </div>
        </div>
